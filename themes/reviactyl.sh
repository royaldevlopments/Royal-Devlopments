...
while true; do
    ...
    echo -e "  |  _ \ ___  __ _(_)_ __ __ _| | (_)_ __   ___| |_  "
    echo -e "  | |_) / _ \/ _\ | | '__/ _\ | | | \ '_ \ / _ \ __| "
    echo -e "  |  _ <  __/ (_| | | | | (_| | | | | | | |  __/ |_  "
    echo -e "  |_| \_\___|\__,_|_|_|  \__,_|_|_|_|_| |_|\___|\__| "
    echo -e "${NC}"
    echo -e "  ${GRAY}──────────────────────────────────────────────${NC}"
    echo -e "  ${GREEN}[1]${NC} Reviactyl Panel"
    ...
    case $p in
        1) run_script "panel/reviactyl/run.sh" ;;
        0) clear; exit ;;
