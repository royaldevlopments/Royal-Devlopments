...
while true; do
    ...
    echo -e "${CYAN}  / __|___ _ _  _ _  ___  | _ \_ _ ___ _  _ _ __   ${NC}"
    echo -e "${CYAN} | (__/ _ \ ' \| ' \/ _ \ |  _/ '_/ _ \ || | '_ \  ${NC}"
    echo -e "${CYAN}  \___\___/_||_|_||_\___/ |_| |_| \___/\_,_| .__/  ${NC}"
    echo -e "${CYAN}                                            |_|     ${NC}"
    echo ""
    ...
    echo ""
    echo -ne "${BOLD}${WHITE}  convoy:~# ${NC}"
    read choice

    case $choice in
        1) run_script "panel/convoy/install.sh" ;;
        2) run_script "panel/convoy/update.sh" ;;
        3) run_script "panel/convoy/uninstall.sh" ;;
        4) run_script "panel/convoy/user.sh" ;;
        5) run_script "panel/convoy/domain.sh" ;;
