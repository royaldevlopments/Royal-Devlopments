...
EOF
    echo -e "${NC}"
    echo -e "${PURPLE}════════════════════════════════════════════════════════════${NC}"
    echo -e "${PURPLE}║${NC}           ${BOLD}${WHITE}SKYPORT PANEL MANAGEMENT${NC}                 ${PURPLE}║${NC}"
    echo -e "${PURPLE}════════════════════════════════════════════════════════════${NC}"
    echo ""
    if [ -d "/var/www/skyport" ]; then
    ...
    echo ""
    echo -ne "${BOLD}${WHITE}  skyport:~# ${NC}"
    read choice

    case $choice in
        1) run_script "panel/skyport/install.sh" ;;
        2) run_script "panel/skyport/update.sh" ;;
        3) run_script "panel/skyport/uninstall.sh" ;;
        4) run_script "panel/skyport/user.sh" ;;
        5) run_script "panel/skyport/domain.sh" ;;
