...
while true; do
    clear
    echo -e "${CYAN}   ╔══════════════════════════════════════════╗${NC}"
    echo -e "${CYAN}   ║           Catalyst Control              ║${NC}"
    echo -e "${CYAN}   ╚══════════════════════════════════════════╝${NC}"
    echo ""
    ...
    echo ""
    echo -ne "${BOLD}${WHITE}  catalyst:~# ${NC}"
    read choice

    case $choice in
        1) run_script "panel/catalyst/install.sh" ;;
        2) run_script "panel/catalyst/update.sh" ;;
        3) run_script "panel/catalyst/uninstall.sh" ;;
        4) run_script "panel/catalyst/user.sh" ;;
        5) run_script "panel/catalyst/domain.sh" ;;
