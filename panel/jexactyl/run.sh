...
while true; do
    ...
    echo -e "${PURPLE} / __|_  ___ __ _| |_ _ __ __ _  ___| |_    ${NC}"
    echo -e "${PURPLE} \__ \ || / __/ _\` |  _| '__/ _\` |/ __| __|  ${NC}"
    echo -e "${PURPLE} |___/\_, \__|\__,_|\__|_|  \__,_|\___|\__|  ${NC}"
    echo -e "${PURPLE}      |__/                                   ${NC}"
    echo ""
    ...
    echo ""
    echo -ne "${BOLD}${WHITE}  jexactyl:~# ${NC}"
    read choice

    case $choice in
        1) run_script "panel/jexactyl/install.sh" ;;
        2) run_script "panel/jexactyl/update.sh" ;;
        3) run_script "panel/jexactyl/uninstall.sh" ;;
        4) run_script "panel/jexactyl/user.sh" ;;
        5) run_script "panel/jexactyl/domain.sh" ;;
