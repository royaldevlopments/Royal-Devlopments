...
while true; do
    clear
    echo -e "${GOLD}   _____  ____  ____  _______ _ _ _                     ${NC}"
    echo -e "${GOLD}  |  ___|/ ___|| __ )| ____(_) | | |                    ${NC}"
    echo -e "${GOLD}  | |_   \___ \|  _ \|  _| | | | | |                    ${NC}"
    echo -e "${GOLD}  |  _|   ___) | |_) | |___| | | | |                    ${NC}"
    echo -e "${GOLD}  |_|    |____/|____/|_____|_|_|_|_|                    ${NC}"
    echo ""
    ...
    echo ""
    echo -ne "${BOLD}${WHITE}  fossbilling:~# ${NC}"
    read choice

    case $choice in
        1) run_script "panel/fossbilling/install.sh" ;;
        2) run_script "panel/fossbilling/update.sh" ;;
        3) run_script "panel/fossbilling/uninstall.sh" ;;
        4) run_script "panel/fossbilling/user.sh" ;;
        5) run_script "panel/fossbilling/domain.sh" ;;
