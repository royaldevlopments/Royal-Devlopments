...
while true; do
    ...
    echo -e "${CYAN}  |  _ \ __ _ ___| |_ __ _ _ __   __ _ _ __   ___| |     ${NC}"
    echo -e "${CYAN}  | |_) / _\ / __| __/ _\ | '_ \ / _\ | '_ \ / _ \ |    ${NC}"
    echo -e "${CYAN}  |  __/ (_| \__ \ || (_| | | | | (_| | | | |  __/ |    ${NC}"
    echo -e "${CYAN}  |_|   \__,_|___/\__\__,_|_| |_|\__,_|_| |_|\___|_|    ${NC}"
    echo ""
    ...
    echo ""
    echo -ne "${BOLD}${WHITE}  portainer:~# ${NC}"
    read choice

    case $choice in
        1) run_script "panel/portainer/install.sh" ;;
        2) run_script "panel/portainer/update.sh" ;;
        3) run_script "panel/portainer/uninstall.sh" ;;
        4) echo "  N/A" ;;
        5) echo "  N/A" ;;
