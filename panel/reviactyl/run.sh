...
EOF
    echo -e "${NC}"
    echo -e "${PURPLE}════════════════════════════════════════════════════════════${NC}"
    echo -e "${PURPLE}║${NC}         ${BOLD}${WHITE}REVIACTYL PANEL MANAGEMENT${NC}                  ${PURPLE}║${NC}"
    echo -e "${PURPLE}════════════════════════════════════════════════════════════${NC}"
    echo ""
    ...
    echo ""
    echo -ne "${BOLD}${WHITE}  reviactyl:~# ${NC}"
    read choice

    case $choice in
        1) run_script "panel/reviactyl/install.sh" ;;
        2) run_script "panel/reviactyl/update.sh" ;;
        3) run_script "panel/reviactyl/uninstall.sh" ;;
        4) run_script "panel/reviactyl/user.sh" ;;
        5) run_script "panel/reviactyl/domain.sh" ;;
