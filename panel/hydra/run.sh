...
EOF
    echo -e "${NC}"
    echo -e "${PURPLE}════════════════════════════════════════════════════════════${NC}"
    echo -e "${PURPLE}║${NC}         ${BOLD}${WHITE}HYDRAPANEL MANAGEMENT${NC}                        ${PURPLE}║${NC}"
    echo -e "${PURPLE}════════════════════════════════════════════════════════════${NC}"
    echo ""
    if [ -d "/var/www/hydra" ]; then
    ...
    echo ""
    echo -ne "${BOLD}${WHITE}  hydra:~# ${NC}"
    read choice

    case $choice in
        1) run_script "panel/hydra/install.sh" ;;
        2) run_script "panel/hydra/update.sh" ;;
        3) run_script "panel/hydra/uninstall.sh" ;;
        4) run_script "panel/hydra/user.sh" ;;
        5) run_script "panel/hydra/domain.sh" ;;
