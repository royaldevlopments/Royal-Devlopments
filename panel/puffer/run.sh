...
EOF
    echo -e "${NC}"
    echo -e "${PURPLE}════════════════════════════════════════════════════════════${NC}"
    echo -e "${PURPLE}║${NC}         ${BOLD}${WHITE}PUFFERPANEL MANAGEMENT${NC}                        ${PURPLE}║${NC}"
    echo -e "${PURPLE}════════════════════════════════════════════════════════════${NC}"
    echo ""
    ...
    echo ""
    echo -ne "${BOLD}${WHITE}  puffer:~# ${NC}"
    read choice

    case $choice in
        1) run_script "panel/puffer/install.sh" ;;
        2) run_script "panel/puffer/update.sh" ;;
        3) run_script "panel/puffer/uninstall.sh" ;;
        4) run_script "panel/puffer/user.sh" ;;
        5) run_script "panel/puffer/domain.sh" ;;
